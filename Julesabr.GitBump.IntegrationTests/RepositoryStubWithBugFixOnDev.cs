...
namespace Julesabr.GitBump.IntegrationTests {
    public static class RepositoryStubWithBugFixOnDev {
        public static IRepository Create() {
            ...
            tag5.Name.Returns("startup-bug-fix");
            tag5.IsAnnotated.Returns(false);
