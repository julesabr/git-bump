...
namespace Julesabr.GitBump {
    public class Options {
        ...
        [Option(Default = false, HelpText = "Toggle this version bump as a prerelease. Prerelease versions will be in the format x.y.z.<branch>.n where 'branch' is the name of the current git branch and n is the build number. Prereleases will bump the build number before bumping the major, minor, or patch.")]
