...
namespace Julesabr.GitBump.Tests {
    public class GitServiceTest {
        ...
        [Test]
        public void CreateAnnotatedTag_GivenGitTagIsNotNull_CanGetTaggerFromConfig_AndRepositoryAppliesTag_ThenReturnSuccessfully() {
            ...
            tags.Add(Arg.Any<string>(), Arg.Any<GitObject>(), Arg.Any<Signature>(), Arg.Any<string>()).Returns(Substitute.For<Tag>());
        ...
        public void CreateAnnotatedTag_WhenRepositoryFailedToApplyTag_ThenThrowOperationFailedException() {
            ...
            Signature tagger = new("foo", "bar", DateTimeOffset.MaxValue);
            config.BuildSignature(Arg.Any<DateTimeOffset>()).Returns(tagger);
            tags.Add(Arg.Any<string>(), Arg.Any<GitObject>(), Arg.Any<Signature>(), Arg.Any<string>()).Returns((Tag?)null);
