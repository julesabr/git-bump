...
namespace Julesabr.GitBump.Tests {
    public class GitTagTest {
        ...
        public void Create_GivenGitTagAsValidString_PrefixIsNotNull_AndSuffixIsNotNull_ThenReturnGitTagObject() {
            IGitTag.Create("pre1.2.3-post", "pre", "-post").Should()
        ...
        public void Create_GivenGitTagAsValidString_AndPrefixIsNullOrEmpty_ThenReturnGitTagObject(string prefix) {
            IGitTag.Create("1.2.3-post", prefix, "-post").Should()
        ...
        public void Create_GivenGitTagAsValidString_AndSuffixIsNullOrEmpty_ThenReturnGitTagObject(string suffix) {
            IGitTag.Create("pre1.2.3", "pre", suffix).Should()
        ...
        public void ToString_WhenVersionIsNotPrerelease_ThenReturnGitTagAsStringInReleaseFormat(uint major, uint minor, 
            uint patch, string? prefix, string? suffix, string value) {
        ...
        [TestCase(1u, 6u, 2u, "staging", 15u, null, "u", 
            "1.6.2.staging.15u")]
        public void ToString_WhenVersionIsPrerelease_ThenReturnGitTagAsStringInPrereleaseFormat(uint major, uint minor, 
            uint patch, string prereleaseBranch, uint prereleaseBuild, string? prefix, string? suffix, string value) {
